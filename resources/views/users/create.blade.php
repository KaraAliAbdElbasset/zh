                ...
                <div class="card-body ">
                    <form method="post" action="{{route('users.store')}}">
                        ...
                        <div class="form-group  @error('name') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" value="{{old('name')}}" id="name" name="name" placeholder="{{__('names.f_name')}}">
                            @error('name')
                        ...
                        <div class="form-group  @error('email') has-danger @enderror">
                            ...
                            <input type="email" class="form-control" value="{{old('email')}}" id="email" name="email" placeholder="{{__('names.email')}}">
                            @error('email')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
