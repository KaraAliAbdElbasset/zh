    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body ">
                    <form method="post" action="{{route('sewing-clients.store')}}">
                        @csrf
                        ...
                        <div class="form-group  @error('phone_number') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" value="{{old('phone_number')}}" id="phone_number" name="phone_number" placeholder="{{__('names.phone_number')}}">
                            @error('phone_number')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        <div class="form-group  @error('address') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" value="{{old('address')}}" id="address" name="address" placeholder="{{__('names.address')}}">
                            @error('address')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
