                ...
                <div class="card-body ">
                    <form method="post" action="{{route('clubs.update',$club->id)}}">
                        ...
                        <div class="form-group  @error('managing_office') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" name="managing_office" value="{{old('managing_office',$club->managing_office)}}" id="managing_office"  placeholder="{{__('names.managing_office')}}">
                        ...
                        <div class="form-group  @error('goals') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" name="goals" value="{{old('goals',$club->goals)}}" id="goals"  placeholder="{{__('names.goals')}}">
                            @error('goals')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
