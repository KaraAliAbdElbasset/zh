    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body ">
                    <form method="post" action="{{route('general-statistics.store')}}">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-group @error('job') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" id="job" name="job" value="{{old('job')}}" placeholder="{{__('names.job')}}">
                            @error('job')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group @error('job_address') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" id="job_address" name="job_address" value="{{old('job_address')}}" placeholder="{{__('names.job_address')}}">
                            @error('job_address')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group @error('serial_number') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" id="serial_number" name="serial_number" value="{{old('serial_number')}}" placeholder="{{__('names.serial_number')}}">
                            @error('serial_number')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group @error('national_number') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" id="national_number" name="national_number" value="{{old('national_number')}}" placeholder="{{__('names.national_number')}}">
                        ...
                        <div class="form-group @error('social_status') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" id="social_status" name="social_status" value="{{old('social_status')}}" placeholder="{{__('names.social_status')}}">
                            @error('social_status')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
