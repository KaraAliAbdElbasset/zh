                    ...
                    <form method="post" action="{{route('students.store')}}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 @error('first_name_fr') has-danger @enderror">
                                ...
                                <input type="text" class="form-control" value="{{old('first_name_fr')}}" id="first_name_fr" name="first_name_fr" placeholder="{{__('names.f_name_fr')}}">
                                @error('first_name_fr')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-6 @error('last_name_fr') has-danger @enderror">
                                ...
                                <input type="text" class="form-control" id="last_name_fr" value="{{old('last_name_fr')}}" name="last_name_fr"  placeholder="{{__('names.l_name_fr')}}">
                                @error('last_name_fr')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group @error('academic_average_1') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" id="academic_average_1" name="academic_average_1" value="{{old('academic_average_1')}}" placeholder="{{__('names.academic_average_1')}}">
                        ...
                        <div class="form-group @error('academic_average_2') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" id="academic_average_2" name="academic_average_2" value="{{old('academic_average_2')}}" placeholder="{{__('names.academic_average_2')}}">
                        ...
                        <div class="form-group @error('academic_average_3') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" id="academic_average_3" name="academic_average_3" value="{{old('academic_average_3')}}" placeholder="{{__('names.academic_average_3')}}">
                        ...
                        <div class="form-group @error('memorization_level') has-danger @enderror">
                            ...
                            <input type="text" class="form-control" id="memorization_level" name="memorization_level" value="{{old('memorization_level')}}" placeholder="{{__('names.memorization_level')}}">
